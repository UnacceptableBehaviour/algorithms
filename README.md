...
| Lectures                                                                | Recitations                                                         | Problem Sets                                                                                                                                                      | Example Code | Solutions                                                                  | Implementation                                                                                | Other |
|-------------------------------------------------------------------------|---------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|----------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|-------|
...
| :white_check_mark: 02. Models of Computation, Document Distance         | :flashlight: R02. Python Cost Model, Document Distance              |                                                                                                                                                                   |              | [Set 1](https://github.com/UnacceptableBehaviour/algorithms#problem-set-1) | [Python](https://github.com/UnacceptableBehaviour/algorithms/blob/master/algos/merge_sort.py) |       |
| :white_check_mark: 03. Insertion Sort, Merge Sort                       | :flashlight: R03. Document Distance, Insertion and Merge Sort       | [Set 2 PDF](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-006-introduction-to-algorithms-fall-2011/assignments/MIT6_006F11_ps2.pdf)   |              |                                                                            |                                                                                               |       |
| :white_check_mark: 04. Heaps and Heap Sort                              |                                                                     |                                                                                                                                                                   |              |                                                                            |                                                                                               |       |
| :white_check_mark: 05. Binary Search Trees, BST Sort                    | :flashlight: R05. Recursion Trees, Binary Search Trees              |                                                                                                                                                                   |              |                                                                            |                                                                                               |       |
| :white_check_mark: 06. AVL Trees, AVL Sort                              | :flashlight: R06. AVL Trees                                         |                                                                                                                                                                   |              |                                                                            |                                                                                               |       |
...
| :flashlight: 08. Hashing with Chaining                                  | :flashlight: R08. Simulation Algorithms                             |                                                                                                                                                                   |              |                                                                            |                                                                                               |       |
