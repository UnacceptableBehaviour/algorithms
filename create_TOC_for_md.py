...
if __name__ == '__main__':
    ...
    if '-p' in sys.argv:
        return_code = subprocess.call(['git','add','README.md']) # note command separation inside list! [ ]
        print(f"git add README.md: {return_code}")          # ^----/
    
        return_code = subprocess.call(["git","commit","-m'added autogenerated README.md'"])
        print(f"git commit -m'added autogenerated README.md': {return_code}")
